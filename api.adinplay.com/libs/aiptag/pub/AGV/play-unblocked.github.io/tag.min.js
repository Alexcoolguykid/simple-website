...
aiptag.settings = {
	sVersion: '7.0',
	sUpdated: 'Friday 27 September 2024 - 11:14',
	sUpdatedShort: '27/09/24 11:14',
	sUpdateID: '66f6775f841db',
	sPubName: 'AGV',
	sSellerId: 'AGV',
	sPubUrl: 'play-unblocked.github.io',
	sAdUnitVideo: 'play-unblocked.github.io_preroll',
	sAdBreakChannel: '',
	sGameInterstitialAdUnit: '',
	sAdUnitAudio: '',
	sAdUnitInterstitial: 'play-unblocked.github.io_interstitial',
	...
	iTimeoutPlayer: 8000,
	sNetworkIdRewarded: '421469808,22458295241',
	...
	iMCM: true,
	iMCMiD: '22458295241',
	sNetworkIdVideo: '421469808,22458295241',
	iAmazonVideoAds: false,
	sNetworkIdDisplay: '421469808,22458295241',
...
function aipAPI() {
	...
	if(aiptag.settings.sAdUnitVideo) {
		...
		this.videoAdUnit["play-unblocked.github.io_preroll"] = {
code: 'prerollUnit',
ortb2Imp: {
	ext: {
		gpid: 'prerollUnit',
	...
	},
	{
...
};this.videoAdUnitMaxDuration["play-unblocked.github.io_preroll"] = "30000";this.videoAdUnitSkipButtonTimeout["play-unblocked.github.io_preroll"] = false;	}

			this.adUnits['play-unblocked-github-io_300x250'] = [{
		code: 'play-unblocked-github-io_300x250',
		ortb2Imp: {
			ext: {
				gpid: 'play-unblocked-github-io_300x250',
				data: {
					pbadslot: 'play-unblocked-github-io_300x250'
				}
			}
		},
		mediaTypes: {
		...
		bids: [
			...
			},
			{
				...
				params: {
					...
					ext: { placement_name: 'play-unblocked.github.io_300x250'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '32623588'
				}
			}
		]
	}];
		this.adSlots['play-unblocked-github-io_300x250'] = {adunit: 'play-unblocked.github.io_300x250', sizes: [300, 250], reload: true, autoRefresh: true, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: true, fallback: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['play-unblocked-github-io_300x250'] = [{slotID: 'play-unblocked-github-io_300x250', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/play-unblocked.github.io_300x250', sizes: [[300, 250]]}];
		}
		this.requestManager['play-unblocked-github-io_300x250'] = {adserverRequestSent: false, aps: false, prebid: false};

		try{
			if(aiptag.settings.iDisableAdWhenNotInTheActiveView === true) {
				this.observeTarget('play-unblocked-github-io_300x250', true);
			}
		} catch(e){}

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['play-unblocked-github-io_300x250'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['play-unblocked-github-io_300x250'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['play-unblocked-github-io_300x250'].autoRefreshHasFocus+" for: "+this.adSlots['play-unblocked-github-io_300x250'].adunit);
			} catch(e){}
			*/
					this.adUnits['play-unblocked-github-io_300x250_2'] = [{
		code: 'play-unblocked-github-io_300x250_2',
		ortb2Imp: {
			ext: {
				gpid: 'play-unblocked-github-io_300x250_2',
				data: {
					pbadslot: 'play-unblocked-github-io_300x250_2'
				}
			}
		},
		mediaTypes: {
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'play-unblocked.github.io_300x250_2'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '32623613'
				}
			}
		]
	}];
		this.adSlots['play-unblocked-github-io_300x250_2'] = {adunit: 'play-unblocked.github.io_300x250_2', sizes: [300, 250], reload: true, autoRefresh: true, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: true, fallback: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['play-unblocked-github-io_300x250_2'] = [{slotID: 'play-unblocked-github-io_300x250_2', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/play-unblocked.github.io_300x250_2', sizes: [[300, 250]]}];
		}
		this.requestManager['play-unblocked-github-io_300x250_2'] = {adserverRequestSent: false, aps: false, prebid: false};

		try{
			if(aiptag.settings.iDisableAdWhenNotInTheActiveView === true) {
				this.observeTarget('play-unblocked-github-io_300x250_2', true);
			}
		} catch(e){}

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['play-unblocked-github-io_300x250_2'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['play-unblocked-github-io_300x250_2'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['play-unblocked-github-io_300x250_2'].autoRefreshHasFocus+" for: "+this.adSlots['play-unblocked-github-io_300x250_2'].adunit);
			} catch(e){}
			*/
					this.adUnits['play-unblocked-github-io_728x90'] = [{
		code: 'play-unblocked-github-io_728x90',
		ortb2Imp: {
			ext: {
				gpid: 'play-unblocked-github-io_728x90',
				data: {
					pbadslot: 'play-unblocked-github-io_728x90'
				}
			}
		},
		mediaTypes: {
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'play-unblocked.github.io_728x90'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '32623676'
				}
			}
		]
	}];
		this.adSlots['play-unblocked-github-io_728x90'] = {adunit: 'play-unblocked.github.io_728x90', sizes: [728, 90], reload: true, autoRefresh: true, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: true, fallback: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['play-unblocked-github-io_728x90'] = [{slotID: 'play-unblocked-github-io_728x90', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/play-unblocked.github.io_728x90', sizes: [[728, 90]]}];
		}
		this.requestManager['play-unblocked-github-io_728x90'] = {adserverRequestSent: false, aps: false, prebid: false};

		try{
			if(aiptag.settings.iDisableAdWhenNotInTheActiveView === true) {
				this.observeTarget('play-unblocked-github-io_728x90', true);
			}
		} catch(e){}

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['play-unblocked-github-io_728x90'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['play-unblocked-github-io_728x90'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['play-unblocked-github-io_728x90'].autoRefreshHasFocus+" for: "+this.adSlots['play-unblocked-github-io_728x90'].adunit);
			} catch(e){}
			*/
					this.adUnits['play-unblocked-github-io_160x600'] = [{
		code: 'play-unblocked-github-io_160x600',
		ortb2Imp: {
			ext: {
				gpid: 'play-unblocked-github-io_160x600',
				data: {
					pbadslot: 'play-unblocked-github-io_160x600'
				}
			}
		},
		mediaTypes: {
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'play-unblocked.github.io_160x600'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '32623639'
				}
			}
		]
	}];
		this.adSlots['play-unblocked-github-io_160x600'] = {adunit: 'play-unblocked.github.io_160x600', sizes: [160, 600], reload: true, autoRefresh: true, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: true, fallback: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['play-unblocked-github-io_160x600'] = [{slotID: 'play-unblocked-github-io_160x600', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/play-unblocked.github.io_160x600', sizes: [[160, 600]]}];
		}
		this.requestManager['play-unblocked-github-io_160x600'] = {adserverRequestSent: false, aps: false, prebid: false};

		try{
			if(aiptag.settings.iDisableAdWhenNotInTheActiveView === true) {
				this.observeTarget('play-unblocked-github-io_160x600', true);
			}
		} catch(e){}

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['play-unblocked-github-io_160x600'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['play-unblocked-github-io_160x600'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['play-unblocked-github-io_160x600'].autoRefreshHasFocus+" for: "+this.adSlots['play-unblocked-github-io_160x600'].adunit);
			} catch(e){}
			*/
					this.adUnits['play-unblocked-github-io_300x600'] = [{
		code: 'play-unblocked-github-io_300x600',
		ortb2Imp: {
			ext: {
				gpid: 'play-unblocked-github-io_300x600',
				data: {
					pbadslot: 'play-unblocked-github-io_300x600'
				}
			}
		},
		mediaTypes: {
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'play-unblocked.github.io_300x600'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '32623389'
				}
			}
		]
	}];
		this.adSlots['play-unblocked-github-io_300x600'] = {adunit: 'play-unblocked.github.io_300x600', sizes: [300, 600], reload: true, autoRefresh: true, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: true, fallback: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['play-unblocked-github-io_300x600'] = [{slotID: 'play-unblocked-github-io_300x600', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/play-unblocked.github.io_300x600', sizes: [[300, 600]]}];
		}
		this.requestManager['play-unblocked-github-io_300x600'] = {adserverRequestSent: false, aps: false, prebid: false};

		try{
			if(aiptag.settings.iDisableAdWhenNotInTheActiveView === true) {
				this.observeTarget('play-unblocked-github-io_300x600', true);
			}
		} catch(e){}

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['play-unblocked-github-io_300x600'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['play-unblocked-github-io_300x600'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['play-unblocked-github-io_300x600'].autoRefreshHasFocus+" for: "+this.adSlots['play-unblocked-github-io_300x600'].adunit);
			} catch(e){}
			*/
					this.adUnits['play-unblocked-github-io_300x600_2'] = [{
		code: 'play-unblocked-github-io_300x600_2',
		ortb2Imp: {
			ext: {
				gpid: 'play-unblocked-github-io_300x600_2',
				data: {
					pbadslot: 'play-unblocked-github-io_300x600_2'
				}
			}
		},
		mediaTypes: {
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'play-unblocked.github.io_300x600_2'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '32623414'
				}
			}
		]
	}];
		this.adSlots['play-unblocked-github-io_300x600_2'] = {adunit: 'play-unblocked.github.io_300x600_2', sizes: [300, 600], reload: true, autoRefresh: true, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: true, fallback: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['play-unblocked-github-io_300x600_2'] = [{slotID: 'play-unblocked-github-io_300x600_2', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/play-unblocked.github.io_300x600_2', sizes: [[300, 600]]}];
		}
		this.requestManager['play-unblocked-github-io_300x600_2'] = {adserverRequestSent: false, aps: false, prebid: false};

		try{
			if(aiptag.settings.iDisableAdWhenNotInTheActiveView === true) {
				this.observeTarget('play-unblocked-github-io_300x600_2', true);
			}
		} catch(e){}

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['play-unblocked-github-io_300x600_2'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['play-unblocked-github-io_300x600_2'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['play-unblocked-github-io_300x600_2'].autoRefreshHasFocus+" for: "+this.adSlots['play-unblocked-github-io_300x600_2'].adunit);
			} catch(e){}
			*/
					this.adUnits['play-unblocked-github-io_970x250'] = [{
		code: 'play-unblocked-github-io_970x250',
		ortb2Imp: {
			ext: {
				gpid: 'play-unblocked-github-io_970x250',
				data: {
					pbadslot: 'play-unblocked-github-io_970x250'
				}
			}
		},
		mediaTypes: {
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'play-unblocked.github.io_970x250'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '32623440'
				}
			}
		]
	}];
		this.adSlots['play-unblocked-github-io_970x250'] = {adunit: 'play-unblocked.github.io_970x250', sizes: [970, 250], reload: true, autoRefresh: true, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: true, fallback: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['play-unblocked-github-io_970x250'] = [{slotID: 'play-unblocked-github-io_970x250', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/play-unblocked.github.io_970x250', sizes: [[970, 250]]}];
		}
		this.requestManager['play-unblocked-github-io_970x250'] = {adserverRequestSent: false, aps: false, prebid: false};

		try{
			if(aiptag.settings.iDisableAdWhenNotInTheActiveView === true) {
				this.observeTarget('play-unblocked-github-io_970x250', true);
			}
		} catch(e){}

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['play-unblocked-github-io_970x250'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['play-unblocked-github-io_970x250'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['play-unblocked-github-io_970x250'].autoRefreshHasFocus+" for: "+this.adSlots['play-unblocked-github-io_970x250'].adunit);
			} catch(e){}
			*/
					this.adUnits['play-unblocked-github-io_970x250_2'] = [{
		code: 'play-unblocked-github-io_970x250_2',
		ortb2Imp: {
			ext: {
				gpid: 'play-unblocked-github-io_970x250_2',
				data: {
					pbadslot: 'play-unblocked-github-io_970x250_2'
				}
			}
		},
		mediaTypes: {
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'play-unblocked.github.io_970x250_2'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '32623476'
				}
			}
		]
	}];
		this.adSlots['play-unblocked-github-io_970x250_2'] = {adunit: 'play-unblocked.github.io_970x250_2', sizes: [970, 250], reload: true, autoRefresh: true, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: true, fallback: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['play-unblocked-github-io_970x250_2'] = [{slotID: 'play-unblocked-github-io_970x250_2', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/play-unblocked.github.io_970x250_2', sizes: [[970, 250]]}];
		}
		this.requestManager['play-unblocked-github-io_970x250_2'] = {adserverRequestSent: false, aps: false, prebid: false};

		try{
			if(aiptag.settings.iDisableAdWhenNotInTheActiveView === true) {
				this.observeTarget('play-unblocked-github-io_970x250_2', true);
			}
		} catch(e){}

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['play-unblocked-github-io_970x250_2'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['play-unblocked-github-io_970x250_2'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['play-unblocked-github-io_970x250_2'].autoRefreshHasFocus+" for: "+this.adSlots['play-unblocked-github-io_970x250_2'].adunit);
			} catch(e){}
			*/
...
aipAPI.prototype.checkBidders = function() {
	...
	if(aRemoveBidders.length > 0) {
		//removeBidders from display
					this.removeBidders(this.adUnits['play-unblocked-github-io_300x250'], aRemoveBidders);
					this.removeBidders(this.adUnits['play-unblocked-github-io_300x250_2'], aRemoveBidders);
					this.removeBidders(this.adUnits['play-unblocked-github-io_728x90'], aRemoveBidders);
					this.removeBidders(this.adUnits['play-unblocked-github-io_160x600'], aRemoveBidders);
					this.removeBidders(this.adUnits['play-unblocked-github-io_300x600'], aRemoveBidders);
					this.removeBidders(this.adUnits['play-unblocked-github-io_300x600_2'], aRemoveBidders);
					this.removeBidders(this.adUnits['play-unblocked-github-io_970x250'], aRemoveBidders);
					this.removeBidders(this.adUnits['play-unblocked-github-io_970x250_2'], aRemoveBidders);
		
		//removeBidders from preroll
						this.removeBidders([this.videoAdUnit["play-unblocked.github.io_preroll"]], aRemoveBidders);
					}
}
...
this.adSlots['play-unblocked-github-io_300x250']['sizes'] = [[336, 280], [300, 250]];
this.adUnits['play-unblocked-github-io_300x250'][0]['mediaTypes']['banner']['sizes'] = [[336, 280], [300, 250]];

this.adSlots['play-unblocked-github-io_300x250_2']['sizes'] = [[336, 280], [300, 250]];
this.adUnits['play-unblocked-github-io_300x250_2'][0]['mediaTypes']['banner']['sizes'] = [[336, 280], [300, 250]];

this.adSlots['play-unblocked-github-io_160x600']['sizes'] = [[160, 600], [120, 600]];
this.adUnits['play-unblocked-github-io_160x600'][0]['mediaTypes']['banner']['sizes'] = [[160, 600], [120, 600]];

this.adSlots['play-unblocked-github-io_300x600']['sizes'] = [[300, 600], [300, 250], [160, 600], [120, 600]];
this.adUnits['play-unblocked-github-io_300x600'][0]['mediaTypes']['banner']['sizes'] = [[300, 600], [300, 250], [160, 600], [120, 600]];

this.adSlots['play-unblocked-github-io_300x600_2']['sizes'] = [[300, 600], [300, 250], [160, 600], [120, 600]];
this.adUnits['play-unblocked-github-io_300x600_2'][0]['mediaTypes']['banner']['sizes'] = [[300, 600], [300, 250], [160, 600], [120, 600]];

this.adSlots['play-unblocked-github-io_970x250']['sizes'] = [[970, 250], [970, 90], [300, 250], [728, 90]];
this.adUnits['play-unblocked-github-io_970x250'][0]['mediaTypes']['banner']['sizes'] = [[970, 250], [970, 90], [300, 250], [728, 90]];

this.adSlots['play-unblocked-github-io_970x250_2']['sizes'] = [[970, 250], [970, 90], [300, 250], [728, 90]];
this.adUnits['play-unblocked-github-io_970x250_2'][0]['mediaTypes']['banner']['sizes'] = [[970, 250], [970, 90], [300, 250], [728, 90]];
...
aipAPI.prototype.sendStats = function() {
	...
	try {
		...
		if (!window.location.href.includes("adinplay.com")) {
			var data = JSON.stringify({"jspath":"api.adinplay.com/libs/aiptag/pub/AGV/play-unblocked.github.io/tag.min.js"});
	...
	try {
		...
		rawFile.onreadystatechange = function() {
			if (rawFile.readyState === 4) {
				...
				var aip_id = "AGV/play-unblocked.github.io";
				var seller_id_js = "AGV";
				var mcm_js = "22458295241";
